...
class Team_members extends Security_Controller {
    ...
    function save_account_settings($user_id) {
        ...
        $smtp_password = $this->request->getPost('email_smtp_password') === "******"
                            ? $user_info->email_smtp_password
                            : encode_id($this->request->getPost('email_smtp_password'), "email_smtp_pass");
        ...
        $account_data = array(
            ...
            "email_smtp_security_type" => $this->request->getPost('email_smtp_security_type'),
        );
