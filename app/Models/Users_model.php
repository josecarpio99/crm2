...
class Users_model extends Crud_model {
    ...
    function get_access_info($user_id = 0) {
        ...
        $sql = "SELECT $users_table.id, $users_table.user_type, $users_table.is_admin, $users_table.role_id, $users_table.email,
            $users_table.first_name, $users_table.last_name, $users_table.image, $users_table.message_checked_at, $users_table.notification_checked_at, $users_table.client_id, $users_table.enable_web_notification, $users_table.email_smtp_host,
            $users_table.email_smtp_user, $users_table.email_smtp_password, $users_table.email_smtp_port, 
            $users_table.email_smtp_security_type, $users_table.is_primary_contact, $users_table.sticky_note,
