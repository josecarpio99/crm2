                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        echo form_input(array(
                            ...
                            "value" => $user_info->email_smtp_host,
                            "class" => "form-control",
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        echo form_input(array(
                            ...
                            "value" => $user_info->email_smtp_user,
                            "class" => "form-control",
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        echo form_password(array(
                            ...
                            "value" => $user_info->email_smtp_password ? "******" : "",
                            "class" => "form-control",
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        echo form_input(array(
                            ...
                            "value" => $user_info->email_smtp_port,
                            "class" => "form-control",
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        echo form_dropdown(
                            ...
                            $user_info->email_smtp_security_type,
                            "class='select2 mini'"
                        );
                        ?>
                    </div>
